...
import Carta, { type CartaProps } from "../componentes/Carta";



const dragonBallCards: CartaProps[] = [
  {
      id: 1,
      nombre: "Goku (Ultra Instinto)",
      fuerza: 99,
      defensa: 95,
      imagen: "/imagenes/Goku UI Sign.jfif",
      descripcion: "El estado definitivo donde el cuerpo reacciona sin pensar. Su agilidad y poder rompen todos los límites conocidos.",
  ...
  },
  {
    ...
    attack: 96,
    defense: 88,
    image: "/imagenes/gohan_bestia.webp",
